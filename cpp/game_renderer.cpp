...
GameRenderer::GameRenderer(openage::Engine *e)
	...
	global_input_context.bind(input::action_t::TOGGLE_DEBUG_GRID, [this]() {
		this->debug_grid_active = !this->debug_grid_active;
	});
	global_input_context.bind(input::action_t::TOGGLE_BLENDING, [this]() {
	...
	global_input_context.bind(input::action_t::TOGGLE_UNIT_DEBUG, [this]() {
